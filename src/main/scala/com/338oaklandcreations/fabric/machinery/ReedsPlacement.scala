...
object ReedsPlacement extends LedPlacement {
  ...
  override val positions = List(
    (90.0, 10.0), (90.0, 10.0),   // Outgoing repeaters
    (90.0, 10.0), (85.0, 10.0), (80.0, 10.0), (75.0, 10.0), (70.0, 10.0), (65.0, 10.0), (60.0, 10.0), (55.0, 10.0), (50.0, 10.0), (45.0, 10.0), (40.0, 10.0),  // 1 - 11
    (35.0, 5.0), (40.0, 5.0), (45.0, 5.0), (50.0, 5.0), (55.0, 5.0), (60.0, 5.0), (65.0, 5.0), (70.0, 5.0), (75.0, 5.0),                                       // 12 - 20
    (75.0, 5.0),(75.0, 5.0),      // Returning repeaters
    (135.0, 10.0), (135.0, 10.0), // Outgoing repeaters
    ...
    (150.0, 5.0),(150.0, 5.0),    // Returning repeaters
    (290.0, 10.0), (290.0, 10.0), // Outgoing repeaters
